...
SSL representations generalise better than supervised training on this small,
...
| **Linear probe, Run 5** | **0.095** | **0.038** | **0.152** |
...
| Run | Samples | Params | Val loss | LP MSE |
|---|---|---|---|---|
| Run 1 | 135 | 3.5M | 0.1417 | 0.719 |
| Run 2 | 875 | 3.5M | 0.0613 | 0.270 |
| Run 3 | 11,550 | 3.5M | 0.0680 | 0.185 |
| Run 4 | 11,550 | 26.6M | 0.0424 | 0.316 |
| Run 5 | 11,550 | 26.6M | 0.0699 | **0.095** |

Key insight: JEPA val loss is not a reliable proxy for downstream LP MSE.
Run 4 achieves the best val loss (0.0424) but worst LP MSE (0.316) among
the 26.6M models. See the report for full analysis.
